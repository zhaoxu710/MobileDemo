...
//	self.navigationController.navigationBar.tintColor = [UIColor colorWithRed:0.20392f green:0.19607f blue:0.61176f alpha:1.0f];
    ...
    UINavigationController *navigation = (UINavigationController *)[self.view viewWithTag:100];
    navigation.navigationBar.tintColor = [UIColor colorWithRed:0.20392f green:0.19607f blue:0.61176f alpha:1.0f];
    
	self.title = @"Push Client";
    UIBarButtonItem *rightButton = [[UIBarButtonItem alloc] initWithTitle:@"Register"
                                                                    style:UIBarButtonItemStyleDone target:nil action:nil];
    UIBarButtonItem *leftButton = [[UIBarButtonItem alloc] initWithTitle:@"Unregister"
                                   
                                                                   style:UIBarButtonItemStyleDone target:nil action:nil];
    
    navigation.navigationItem.leftBarButtonItem = leftButton;
    
    navigation.navigationItem.rightBarButtonItem = rightButton;
...
- (void)application:(UIApplication *)application didReceiveRemoteNotification:(NSDictionary *)userInfo
{
	...
	[self showString:status];
	CFShow((__bridge CFTypeRef)([userInfo description]));
}
...
- (void)applicationDidFinishLaunching:(UIApplication *)application {
	...
	UINavigationController *nav = [[UINavigationController alloc] initWithRootViewController:[[PushNotificationViewController alloc] init]];
